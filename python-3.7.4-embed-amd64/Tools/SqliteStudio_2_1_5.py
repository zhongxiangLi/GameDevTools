...
#使用python 库
def run():
    tmpZipFilePath=os.getcwd()+"/Tools/sqlitestudio-2.1.5/sqlitestudio-2.1.5.exe.zip"
    ...
    # 直接打开
    tmpExePath=os.getcwd()+"/Tools/sqlitestudio-2.1.5/sqlitestudio-2.1.5.exe/sqlitestudio-2.1.5.exe"
    print(tmpExePath)
