...
def run():
    tmpZipFilePath=os.getcwd()+"/Tools/TextAnalysisTool.NET/TextAnalysisTool.NET.7z"
    ...
    tmpExePath=os.getcwd()+"/Tools/TextAnalysisTool.NET/TextAnalysisTool.NET/Start.bat"
